const cards = [
    {cardDescriptionTitle:'Diabetes', diseaseDescription:'A chronic condition that affects blood sugar regulation.'},
    {cardDescriptionTitle:'Diabetes', diseaseDescription:'A chronic condition that affects blood sugar regulation.'},
    {cardDescriptionTitle:'Diabetes', diseaseDescription:'A chronic condition that affects blood sugar regulation.'},
    {cardDescriptionTitle:'Diabetes', diseaseDescription:'A chronic condition that affects blood sugar regulation.'},
    {cardDescriptionTitle:'Diabetes', diseaseDescription:'A chronic condition that affects blood sugar regulation.'},
    ...
    cards.forEach(card => {
        ...
        cardContainer.innerHTML = `<div class="card-content-container">
                    <div class="card-image-container">
                        <img class="card-image" src="static/images/diabetes.svg" alt="">
                        <div class="overlay-container"></div>
                    </div>
                    <div class="card-description-container">
                        <p class="card-description-title">${card.cardDescriptionTitle}</p>
                        <p class="disease-description">${card.diseaseDescription}</p>
                    </div>
...
modalDescription.innerText = "Are you sure you want to delete this disease? All associated data will be lost"
