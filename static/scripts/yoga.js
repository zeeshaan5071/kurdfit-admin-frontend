const cards = [
    {cardDescriptionTitle:'Beginner Yoga', timeDescription:'15 minutes'},
    {cardDescriptionTitle:'Beginner Yoga', timeDescription:'15 minutes'},
    {cardDescriptionTitle:'Beginner Yoga', timeDescription:'15 minutes'},
    {cardDescriptionTitle:'Beginner Yoga', timeDescription:'15 minutes'},
    {cardDescriptionTitle:'Beginner Yoga', timeDescription:'15 minutes'},
    ...
    cards.forEach(card => {
        ...
        cardContainer.innerHTML = `<div class="card-content-container">
                    <div class="card-image-container">
                        <img class="card-image" src="static/images/yoga.svg" alt="">
                        <div class="overlay-container"></div>
                    </div>
                    <div class="card-description-container">
                        <p class="card-description-title">${card.cardDescriptionTitle}</p>
                        <div class="yoga-description-container">
                    ...
                    <div class="edit-delete-container">
                        <button class="edit-btn">Manage Sessions</button>
...
modalDescription.innerText = "Are you sure you want to delete this session? All associated data will be lost"
