const cards = [
    {img:'woman-foot-exercise.svg', title:'Weight Loss', description:'Lose body fat and become more defined'},
    {img:'woman-foot-exercise.svg', title:'Weight Loss', description:'Lose body fat and become more defined'},
    {img:'woman-foot-exercise.svg', title:'Weight Loss', description:'Lose body fat and become more defined'},
    {img:'woman-foot-exercise.svg', title:'Weight Loss', description:'Lose body fat and become more defined'},
    {img:'woman-foot-exercise.svg', title:'Weight Loss', description:'Lose body fat and become more defined'},
    ...
    cards.forEach(card => {
        ...
        cardContainer.innerHTML = `<div class="card-content-container">
                    ...
                    <div class="card-description-container">
                        <p class="card-description-title">${card.title}</p>
                        <p class="fitness-goal-description">${card.description}</p>
                    </div>
...
modalDescription.innerText = "Are you sure you want to delete this fitness goal ? All associated data will be lost"